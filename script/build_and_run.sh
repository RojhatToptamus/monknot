...
CORE_SOURCES=(
  ...
  "Sources/MonknotCore/Services/SavedWorkspaceStore.swift"
  ...
  "Sources/MonknotCore/Services/WorkspaceTreeExpansionPersistence.swift"
...
APP_SOURCES=(
  ...
  "Sources/Monknot/Stores/WorkspaceLibraryStore.swift"
