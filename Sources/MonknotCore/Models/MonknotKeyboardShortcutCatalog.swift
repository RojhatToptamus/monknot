...
public enum MonknotKeyboardShortcutCatalog {
    public static let entries: [MonknotKeyboardShortcutHelpEntry] = [
        ...
        MonknotKeyboardShortcutHelpEntry(title: "Add Workspace", shortcut: "⌘O"),
        MonknotKeyboardShortcutHelpEntry(title: "Switch Workspace 1–9", shortcut: "⌃⌘1–9"),
        ...
        MonknotKeyboardShortcutHelpEntry(title: "Inspect Links", shortcut: "⌥⌘L"),
