...
| `@xterm/addon-search` | 0.15.0; `xterm-addon-search.js` | MIT; official npm tarball and source revision recorded in `THIRD_PARTY_NOTICES.md` | Retain notices and ship `ThirdPartyLicenses/xterm-addon-search-MIT.txt` | Verified |
